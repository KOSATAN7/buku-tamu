...
<body>
    ...
    if ($_SESSION['lang'] == "bahasa_indonesia") {
        echo "<tr><th>Id </th><th>Waktu</th><th>Judul</th><th>Isi </th><th>Nama File</th>";
    }

    if ($_SESSION['lang'] == "bahasa_inggris") {
        echo "<tr><th>Id </th><th>Time</th><th>Title</th><th>Content</th><th>File Name</th>";
    }
    ...
    if ($hasil) {
        do {
            ...
            if ($_SESSION['lang'] == "bahasa_inggris") {
                echo "<tr><td>$id_berita</td><td>$waktu_berita</td><td>$judul_en</td><td>$isi_en</td><td><a href='berkas/$nama_file'>$nama_file</a></td>";
            } else if ($_SESSION['lang'] == "bahasa_indonesia") {
                echo "<tr><td>$id_berita</td><td>$waktu_berita</td><td>$judul_id</td><td>$isi_id</td><td><a href='berkas/$nama_file'>$nama_file</a></td>";
            }
